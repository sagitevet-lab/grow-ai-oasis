...
const LearnMore = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-green-100 via-white to-green-50 w-full pt-24 pb-20 px-2 md:px-0 flex flex-col items-center overflow-x-hidden">
      {/* Optimized decorative gradients with reduced blur for better performance */}
      <div className="pointer-events-none absolute left-[-60px] top-[-40px] w-[190px] h-[190px] rounded-full bg-green-200 opacity-30 blur-xl z-0 animate-fade-in will-change-transform" />
      <div className="pointer-events-none absolute right-[-80px] top-[18%] w-[100px] h-[100px] rounded-full bg-green-300 opacity-25 blur-xl z-0 animate-fade-in [animation-delay:50ms] will-change-transform" />
      <div className="pointer-events-none absolute right-[-100px] top-[60px] w-[175px] h-[175px] rounded-full bg-green-400 opacity-15 blur-2xl z-0 animate-fade-in [animation-delay:100ms] will-change-transform" />
      <div className="pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[120px] bg-gradient-to-t from-green-100 via-white blur-md opacity-60 z-0" />
      <div className="pointer-events-none absolute left-[25%] top-[120px] w-[90px] h-[90px] rounded-full bg-emerald-300 opacity-15 blur-lg z-0 animate-fade-in [animation-delay:150ms] will-change-transform" />
      <div className="pointer-events-none absolute left-0 top-0 w-full h-24 bg-gradient-to-b from-green-300 via-white/10 to-transparent opacity-20 z-0" />
      ...
      <div className="relative w-full max-w-3xl z-10">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-6 animate-fade-in [animation-delay:50ms] text-left max-w-4xl mx-auto will-change-transform">
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-green-500 animate-fade-in [animation-delay:100ms] will-change-transform">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-blue-500 animate-fade-in [animation-delay:120ms] will-change-transform">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-blue-400 animate-fade-in [animation-delay:140ms] will-change-transform">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-green-600 animate-fade-in [animation-delay:160ms] will-change-transform">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-green-500 animate-fade-in [animation-delay:180ms] will-change-transform">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-yellow-500 animate-fade-in [animation-delay:200ms] will-change-transform">
          ...
          <div className="mt-8 text-center animate-fade-in [animation-delay:250ms] will-change-transform">
