...
const LearnMore = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-b from-green-100 via-white to-green-50 w-full pt-24 pb-20 px-2 md:px-0 flex flex-col items-center overflow-x-hidden">
      ...
      <div className="pointer-events-none absolute left-[-60px] top-[-40px] w-[190px] h-[190px] rounded-full bg-green-200 opacity-20 blur-3xl z-0" />
      <div className="pointer-events-none absolute right-[-80px] top-[18%] w-[100px] h-[100px] rounded-full bg-green-300 opacity-15 blur-2xl z-0" />
      <div className="pointer-events-none absolute bottom-0 left-1/2 -translate-x-1/2 w-[400px] h-[120px] bg-gradient-to-t from-green-100 via-white blur-md opacity-40 z-0" />

      <div className="relative w-full max-w-3xl z-10">
        {/* About Us & Vision */}
        <section className="mb-12 flex flex-col items-center opacity-0 animate-fade-in">
          <h1 className="text-5xl md:text-6xl font-extrabold text-green-900 mb-6 text-center tracking-tighter">
            About Us
          </h1>
        ...
        {/* What Drives Us */}
        <section className="mb-12 opacity-0 animate-fade-in [animation-delay:200ms]">
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-8 tracking-tight text-center">
            What Drives Us
          </h2>
          <div className="space-y-6 text-left max-w-4xl mx-auto">
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-green-500 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-blue-500 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-blue-400 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-green-600 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="flex items-start gap-4 p-6 bg-white rounded-lg shadow-sm border-l-4 border-yellow-500 transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Our Solution */}
        <section className="mb-14 relative opacity-0 animate-fade-in [animation-delay:400ms]">
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-6 tracking-tight text-center">
        ...
        <section className="mb-14 flex flex-col items-center opacity-0 animate-fade-in [animation-delay:600ms]">
          ...
          <span className="block text-base text-green-600 font-normal mb-7 text-center" style={{ marginTop: "0.25rem" }}>
            Wageningen University Autonomous Greenhouse Challenges
          </span>
          <div className="grid gap-6 md:grid-cols-3 w-full max-w-3xl">
            {/* 2019 Card */}
            <div className="bg-green-50 border border-green-200 rounded-xl p-5 shadow flex flex-col h-full transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Market Opportunity */}
        <section className="mb-14 opacity-0 animate-fade-in [animation-delay:800ms]">
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-5 tracking-tight text-center">
            Market Opportunity
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div className="bg-green-50 rounded-xl p-6 border border-green-100 flex flex-col items-center text-center shadow-sm transform transition-transform duration-300 hover:scale-105">
        ...
        {/* Join the Revolution */}
        <section className="mt-12 mb-6 text-center opacity-0 animate-fade-in [animation-delay:1000ms]">
          ...
          <Button
            className="bg-green-700 hover:bg-green-900 text-white text-lg px-8 py-3 font-bold rounded-lg shadow-lg transition-all duration-200 hover:scale-105"
        ...
        <div className="flex justify-center mt-8">
          <button
            className="underline text-black font-semibold text-base hover:text-green-700 transition-colors duration-200 flex items-center gap-2 bg-transparent p-0 border-0 shadow-none"
