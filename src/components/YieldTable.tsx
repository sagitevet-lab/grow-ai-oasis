...
const YieldTable = () => (
  <section className="py-16 px-6 bg-white">
    <div className="max-w-5xl mx-auto">
      ...
      <p className="text-gray-700 mb-6 text-center text-base animate-fade-in">
        Based on a study conducted by the University of Arizona.
      </p>
      <div className="overflow-x-auto">
        <table className="w-full rounded-lg border border-green-100 shadow text-center bg-green-50">
          <thead>
          ...
          <tbody>
            {data.map((row) => (
              <tr key={row.crop} className="border-t border-green-100 animate-fade-in">
